...
#sig.name <- "test"
#signature <- c("ENSG00000000003", "ENSG00000000005", "ENSG00000000419", "ENSG00000000457", "ENSG00000000460", "ENSG00000000938", "ENSG00000000971", "ENSG00000001036", "ENSG00000001084", "ENSG00000001167")

sig.name <- "sh_targets"
signature <- c("ENSG00000067064","ENSG00000160752")
...
# remove full NA rows
selection <- selection[rowSums(is.na(selection[,2:length(selection)]))<length(selection[,2:length(selection)]),]
