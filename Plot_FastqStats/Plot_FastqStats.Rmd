...
The read file **`r basename(infile)`** (`r formatC(nrow(data), big.mark="'")` reads) was parsed for read Length, meanQuality and GC% used to plot below. Stats data were used to plot histograms for single metrics and density plots for pairs of metrics.
